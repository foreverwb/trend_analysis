...
import { TrendingUp, Activity, BarChart2, Flame, CheckCircle, Clock, AlertCircle } from 'lucide-react';
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-slate-600">共 {sectorETFs.length} 个板块</span>
        </div>
      ...
      {sectorETFs.length === 0 ? (
        ...
        sectorETFs.map((etf, idx) => (
          <div key={etf.symbol} className="bg-white rounded-2xl p-6 border border-slate-200 shadow-lg hover:border-blue-300 hover:shadow-xl transition-all">
            ...
            <HoldingsTable holdings={etf.holdings || []} maxDisplay={20} etfSymbol={etf.symbol} />
          </div>
        ))
      )}
    </div>
